...
/*
	c karakterine komutun ilk indisi atanir ve hangi tirnak tipi oldugu anlasilir(" ya da ').
	komut nulla gelene kadar(pdf tirnagin kapatilmis olup olmadıgini kontrol etmemizi istemiyor)
...
/*
	Bu fonksiyon her cagirildiginda kelime uzunlugunu alir. Ve uzunlugu donderir.
	Eger komutun indisi metakarakter ise metakarakterin genisligi count'a eklenir ve dongu sonlandirilir.
	Eger komutun indisinde tirnak isareti var ise get_quotelen fonksiyonundan tirnagin ve icinin ne kadar uzunkukta oldugu alinir ve ardindan counta eklenir.
